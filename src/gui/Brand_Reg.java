...
public class Brand_Reg extends javax.swing.JDialog {
    ...
    public Brand_Reg(Create_GRN cgrn) {
        this.cgrn = cgrn;
        initComponents();
        this.setIconImage(new ImageIcon(getClass().getResource("/images/LogoIcon.png")).getImage());
    }

    public Brand_Reg(Product_Reg prg) {
        this.prg = prg;
        initComponents();
        this.setIconImage(new ImageIcon(getClass().getResource("/images/LogoIcon.png")).getImage());
    }
    
       public Brand_Reg(Admin_Panel admnp) {
        this.admnp = admnp;
        initComponents();
        this.setIconImage(new ImageIcon(getClass().getResource("/images/LogoIcon.png")).getImage());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Register New Brand");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String branName = jTextField1.getText();
        ...
        if (branName.equals("")) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                MySQL.iud("INSERT INTO `brand`(`name`) VALUES('" + branName + "')");
